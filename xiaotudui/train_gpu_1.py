...
try:
    from .paths import DATASET2_ROOT, checkpoint_path, log_dir
except ImportError:
    from paths import DATASET2_ROOT, checkpoint_path, log_dir
...
train_data = torchvision.datasets.CIFAR10(root=DATASET2_ROOT, train=True, download=True, 
                                         transform=torchvision.transforms.ToTensor())
test_data = torchvision.datasets.CIFAR10(root=DATASET2_ROOT, train=False, download=True, 
                                        transform=torchvision.transforms.ToTensor())
...
for i in range(epoch):
    ...
    torch.save(moli, checkpoint_path("moli_{}.pth".format(i)))
